...
let Array = [1, 2, 3, 4, 5, 6, 9, 12, 15]

console.log("Odd Numbers in Number Array are: " + Array.filter((item) => {
...
let stringArray = ["welocme", "to", "guvi", "full", "stack"]
...
//using Array Defined Above

let sum = Array.reduce((currentTotal, item) => {
